...
full_max_long <- ggdraw()+
  ...
  draw_plot(brt1_plots_max_long$pdp, x=-0.03, scale = 0.975, y = 0.055)
full_max_long
```

```{r helminth max long}
helm_max_long <- ggdraw()+
  draw_plot(brt2_plots_max_long$histo, x=0, scale = 1) +
  draw_plot(brt2_plots_max_long$pdp, x=-0, scale = 1, y = 0.05)
helm_max_long
```
...
virus_max_long <- ggdraw()+
  draw_plot(brt3_plots_max_long$histo, x=0, scale = 1) +
  draw_plot(brt3_plots_max_long$pdp, x=-0, scale = 1, y = 0.055)
virus_max_long
```
