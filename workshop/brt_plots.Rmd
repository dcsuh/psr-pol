...
inv <- pdp::partial(brt1_elith_full, n.trees=brt1_elith_full$n.trees, "MaxLongevity_m", prob = T, train = brt1_train_data)
inv <- pdp::partial(brt2_elith_helm, n.trees=brt2_elith_helm$n.trees, "MaxLongevity_m", prob = T, train = brt2_train_data)
```
