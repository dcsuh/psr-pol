...
ggsave(here("figures", "top_rel_imp.png"), plot = rel_imp_top)
...
maturity_relinf <- brt_ri %>% 
  filter(var == "SexualMaturityAge_d") %>% 
  filter(par_type %in% c("arthropod", "bacteria", "virus", "helminth", "protozoa")) %>%
  filter(var != "ref_count") %>%
  group_by(var) %>%
  ggplot(.,aes(x = var, y = rel.inf, fill = par_type)) + 
...
homerange_relinf <- brt_ri %>% 
  filter(var == "HomeRange_km") %>% 
  filter(par_type %in% c("arthropod", "bacteria", "virus", "helminth", "protozoa")) %>%
  filter(var != "ref_count") %>%
  group_by(var) %>%
  ggplot(.,aes(x = var, y = rel.inf, fill = par_type)) + 
...
gr_area_relinf <- brt_ri %>% 
  filter(var == "GR_Area_km") %>% 
  filter(par_type %in% c("arthropod", "bacteria", "virus", "helminth", "protozoa")) %>%
  filter(var != "ref_count") %>%
  group_by(var) %>%
  ggplot(.,aes(x = var, y = rel.inf, fill = par_type)) + 
...
ggsave(here("figures", "maturity_relinf.png"), plot = maturity_relinf, width = 8.19, height = 4.44)
ggsave(here("figures", "human_relinf.png"), plot = human_relinf, width = 8.19, height = 4.44)
ggsave(here("figures", "homerange_relinf.png"), plot = homerange_relinf, width = 8.19, height = 4.44)
ggsave(here("figures", "gr_area_relinf.png"), plot = gr_area_relinf, width = 8.19, height = 4.44)
...
ggsave(here("figures/pdp/ref_count.png"), ref_count_pdp, width = 4, height = 4)
...
ggsave(here("figures/pdp/sexual_maturity.png"), maturity_pdp, width = 4, height = 4)
...
ggsave(here("figures/pdp/home_range.png"), range_pdp, width = 4, height = 4)
...
ggsave(here("figures/pdp/gr_area.png"), area_pdp, width = 4, height = 4)
...
ggsave(here("figures/pdp/pop_dens.png"), pop_dens_pdp, width = 4, height = 4)
