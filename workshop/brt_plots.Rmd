...
brt7_long_plot_no <- which(brt7_names %in% var_name)
brt8_long_plot_no <- which(brt8_names %in% var_name)
...
subway_full <- brt_ri %>% filter(top_fifteen == T) %>%
  filter(par_type %in% c("arthropod", "helminth", "bacteria", "protozoa", "virus")) %>%
  ggplot(data = ., aes(x = par_type, y = ranking, group = var, size = , shape = var)) +
    geom_line(aes(color = var_type), size = 1) +
    scale_shape_manual(values=1:nlevels(as.factor(brt_ri$var))) +
#    scale_color_discrete(type = getOption("ggplot2.discrete.colour")) + 
...
subway_intersect <- brt_ri %>% filter(top_fifteen == T) %>% 
  filter(par_type %in% c("arthropod", "helminth", "bacteria", "protozoa", "virus")) %>%
  ggplot(data = ., aes(x = par_type, y = ranking, group = var, size = , shape = var)) +
    geom_line(aes(color = var_type, alpha = top_intersect+0.2), size = 1) +
    scale_shape_manual(values=1:nlevels(as.factor(brt_ri$var))) +
#    scale_color_discrete(type = getOption("ggplot2.discrete.colour")) + 
    geom_point(aes(color = var_type, alpha = top_intersect+0.2), size = 10) +
    scale_y_reverse(breaks = 1:nrow(brt_ri)) + 
    labs(x = "Parasite Type", 
         y = "Ranking",
         shape = "Variable",
...
```{r make pdp plots}
max_long_y <- c(3,28)
brt1_plots_max_long <- make_plots(brt1_elith_full, var_name)
brt2_plots_max_long <- make_plots(brt2_elith_helm, var_name, y_fixed = T, y_axis = max_long_y, 
                                  par_type = "helminth")
brt3_plots_max_long <- make_plots(brt3_elith_virus, var_name, y_fixed = T, y_axis = max_long_y, 
                                  par_type = "virus")
brt4_plots_max_long <- make_plots(brt4_elith_arth, var_name, y_fixed = T, y_axis = max_long_y, 
                                  par_type = "arthropod")
brt5_plots_max_long <- make_plots(brt5_elith_bact, var_name, y_fixed = T, y_axis = max_long_y, 
                                  par_type = "bacteria")
brt6_plots_max_long <- make_plots(brt6_elith_proto, var_name, y_fixed = T, y_axis = max_long_y, 
                                  par_type = "protozoa")
```
...
var_name1 <- "maturity_d"

brt2_maturity_plot <- make_plots(brt2_elith_helm, 
                                 var_name1, y_fixed = T, y_axis = maturity_y, par_type = "helminth")
brt3_maturity_plot <- make_plots(brt3_elith_virus, 
                                 var_name1, y_fixed = T, y_axis = maturity_y, par_type = "virus")
brt4_maturity_plot <- make_plots(brt4_elith_arth, 
                                 var_name1, y_fixed = T, y_axis = maturity_y, par_type = "arthropod")
brt5_maturity_plot <- make_plots(brt5_elith_bact, 
                                 var_name1, y_fixed = T, y_axis = maturity_y, par_type = "bacteria")
brt6_maturity_plot <- make_plots(brt6_elith_proto, 
                                 var_name1, y_fixed = T, y_axis = maturity_y, par_type = "protozoa")
...
var_name2 <- "home_range_km2"

brt2_range_plot <- make_plots(brt2_elith_helm, 
                                 var_name2, y_fixed = T, y_axis = range_y, par_type = "helminth")
brt3_range_plot <- make_plots(brt3_elith_virus, 
                                 var_name2, y_fixed = T, y_axis = range_y, par_type = "virus")
brt4_range_plot <- make_plots(brt4_elith_arth, 
                                 var_name2, y_fixed = T, y_axis = range_y, par_type = "arthropod")
brt5_range_plot <- make_plots(brt5_elith_bact, 
                                 var_name2, y_fixed = T, y_axis = range_y, par_type = "bacteria")
brt6_range_plot <- make_plots(brt6_elith_proto, 
                                 var_name2, y_fixed = T, y_axis = range_y, par_type = "protozoa")
...
var_name3 <- "density_n_km2"

brt2_area_plot <- make_plots(brt2_elith_helm, 
                                 var_name3, y_fixed = T, y_axis = area_y, par_type = "helminth")
brt3_area_plot <- make_plots(brt3_elith_virus, 
                                 var_name3, y_fixed = T, y_axis = area_y, par_type = "virus")
brt4_area_plot <- make_plots(brt4_elith_arth, 
                                 var_name3, y_fixed = T, y_axis = area_y, par_type = "arthropod")
brt5_area_plot <- make_plots(brt5_elith_bact, 
                                 var_name3, y_fixed = T, y_axis = area_y, par_type = "bacteria")
brt6_area_plot <- make_plots(brt6_elith_proto, 
                                 var_name3, y_fixed = T, y_axis = area_y, par_type = "protozoa")
...
var_name4 <- "weaning_mass_g"

brt2_pop_dens_plot <- make_plots(brt2_elith_helm,
                                 var_name4, y_fixed = T, y_axis = pop_dens_y, par_type = "helminth")
brt3_pop_dens_plot <- make_plots(brt3_elith_virus,
                                 var_name4, y_fixed = T, y_axis = pop_dens_y, par_type = "virus")
brt4_pop_dens_plot <- make_plots(brt4_elith_arth,
                                 var_name4, y_fixed = T, y_axis = pop_dens_y, par_type = "arthropod")
brt5_pop_dens_plot <- make_plots(brt5_elith_bact,
                                 var_name4, y_fixed = T, y_axis = pop_dens_y, par_type = "bacteria")
brt6_pop_dens_plot <- make_plots(brt6_elith_proto,
                                 var_name4, y_fixed = T, y_axis = pop_dens_y, par_type = "protozoa")
...
```{r}
ref_count_pdp
maturity_pdp #maturity_d
range_pdp #home_rangekm2
density_pdp #density_n_km2
weaning_mass_pdp #weaning_mass_g
```
