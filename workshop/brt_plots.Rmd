...
brt2_maturity_plot <- make_plots(brt2_elith_helm, "SexualMaturityAge_d", y_fixed = T, y_axis = maturity_y, par_type = "helminth")
brt3_maturity_plot <- make_plots(brt3_elith_virus, "SexualMaturityAge_d", y_fixed = T, y_axis = maturity_y, par_type = "")
brt4_maturity_plot <- make_plots(brt4_elith_arth, "SexualMaturityAge_d", y_fixed = T, y_axis = maturity_y, par_type = "")
brt5_maturity_plot <- make_plots(brt5_elith_bact, "SexualMaturityAge_d", y_fixed = T, y_axis = maturity_y, par_type = "")
brt6_maturity_plot <- make_plots(brt6_elith_proto, "SexualMaturityAge_d", y_fixed = T, y_axis = maturity_y, par_type = "")
...
```{r}
top_vars %>% filter(par_type %in% c("arthropod", "bacteria", "virus", "helminth", "protozoa")) %>%
  group_by(par_type) %>%
