...
```
```{r gmpd pdp 6}
gbm.plot(brt1_elith_full, n.plots=6, plot.layout=c(2, 3), write.title = FALSE)
gbm.plot(brt2_elith_macro, n.plots=6, plot.layout=c(2, 3), write.title = FALSE)
gbm.plot(brt3_elith_micro, n.plots=6, plot.layout=c(2, 3), write.title = FALSE)
```
...
gbm.plot(brt1_elith_full, variable.no = brt1_long_plot_no, plot.layout=c(1, 1), write.title = FALSE)
gbm.plot(brt2_elith_macro, variable.no = brt2_long_plot_no, plot.layout=c(1, 1), write.title = FALSE)
gbm.plot(brt3_elith_micro, variable.no = brt2_long_plot_no, plot.layout=c(1, 1), write.title = FALSE)
```
